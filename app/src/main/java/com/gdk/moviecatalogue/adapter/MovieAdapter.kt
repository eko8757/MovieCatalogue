...
class MovieAdapter(val items: List<MovieResponse.ResultMovie>) : RecyclerView.Adapter<MovieAdapter.MovieViewHolder>() {
    ...
    class MovieViewHolder(val view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindData(item: MovieResponse.ResultMovie, itemClickListener: OnItemClickListener) {
